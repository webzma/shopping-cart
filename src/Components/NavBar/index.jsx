...
const Navbar = () => {
  ...
  return (
    <nav className="flex bg-white justify-between sm:justify-center lg:justify-between items-center fixed z-10 top-0 w-full  py-5 px-6 sm:px-8 text-sm font-light">
